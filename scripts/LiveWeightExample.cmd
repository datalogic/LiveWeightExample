...
Echo.
Echo.
Echo    Please wait while loading the LiveWeightExample application...
Echo.
Echo.
REM All arguments are passed to liveweightexample.LiveWeightExample
...
REM Run LiveWeightExample.jar with the working directory the JavaPOS directory.
...
REM  liveweightexample.LiveWeightExample is the 
...
java^
    ...
    liveweightexample.LiveWeightExample %*

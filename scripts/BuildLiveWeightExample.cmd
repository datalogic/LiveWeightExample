...
@echo.
@echo --------------------------------
@echo BuildLiveWeightExample.cmd builds
...
@echo.
@echo BuildLiveWeightExample.cmd does not use NetBeans.
...
move /y ..\src\LiveWeightExample.jar 1>NUL
copy /y ..\scripts\LiveWeightExample.cmd 1>NUL
copy /y ..\scripts\LiveWeightExample.sh 1>NUL
...
move /y ..\src\liveweightexample\*.class 1>NUL

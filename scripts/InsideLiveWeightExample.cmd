...
@echo.
@echo --------------------------------
@echo InsideLiveWeightExample.cmd ^<option^>
...
if /i "%errorlevel%" NEQ "0" (
    ...
    @echo Run BuildLiveWeightExample.cmd to create ..\dist_via_jdk.
    goto ExitLbl
)

REM List contents of LiveWeightExample.jar.
@echo on
...
REM List contents of LiveWeightExample.jar MANIFEST.MF.
...
if /i "%errorlevel%" NEQ "0" (
    @echo.
    @echo The .cmd file failed to run successfully.
    @echo It is likely LiveWeightExample.jar does not contain a MANIFEST.MF file.
    goto ExitLbl
)
cd ..
rmdir /S /Q temp_dir 2>NUL
